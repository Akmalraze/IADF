    ...
    <div class="container py-5">
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-3 text-center mb-4 mb-md-0">
                <img src="{{ asset('gambar/harith.jpeg') }}"
            ...
            <!-- Profile Info -->
            <div class="col-md-9">
                <h1 class="fw-bold text-dark mb-1">MUHAMMAD HARITH BIN ZULHAIRI</h1>
                <h4 class="text-primary fw-semibold mb-3">Backend Developer</h4>
                <p class="text-secondary">
                    Hello! I'm <strong>Harith</strong>, a passionate developer who loves crafting clean,
